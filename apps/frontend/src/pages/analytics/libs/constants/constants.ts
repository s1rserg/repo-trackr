...
export const metricOptions = {
	...
	issuesAssignedClosed: { key: "issuesAssignedClosed", label: "Issues Assigned Closed" },
	pullsOpened: { key: "pullsOpened", label: "Pull Requests Opened" },
	pullsOpenedMerged: { key: "pullsOpenedMerged", label: "Pull Requests Opened Merged" },
	pullsAssigned: { key: "pullsAssigned", label: "Pull Requests Assigned" },
	pullsAssignedMerged: { key: "pullsAssignedMerged", label: "Pull Requests Assigned Merged" },
